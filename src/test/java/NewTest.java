...
public class NewTest {
  ...
  public void f() throws InterruptedException {
	  ...
	  loginButton.click();
		/*
		 * WebElement viewProfile = driver.findElement(By.xpath(
		 * "/html/body/main/div/div/div/div/div/div[3]/div/div[3]/div[2]/a"));
		 * viewProfile.click();
		 * 
		 * WebElement pencilButton = driver.findElement(By.xpath(
		 * "//*[@id=\"root\"]/div/div/span/div/div/div/div/div/div[1]/div[1]/div/div/div/div[2]/div[1]/div/div[1]/em"
		 * )); pencilButton.click();
		 * 
		 ...
		 * "/html/body/div[6]/div[9]/div[2]/div/form/div[7]/div/button"))).click();
		 */  
